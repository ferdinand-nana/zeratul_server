...
insert into users(user_nm, passwd, user_typ, user_pos_time, latitude, longitude, address, phone) values ('wilTow', 'password3', 0, CURRENT_TIMESTAMP, 14.6386, 121.03758, 'Beside Wil Tower', '+654789321')
insert into users(user_nm, passwd, user_typ, user_pos_time, latitude, longitude, address, phone) values ('contis', 'password3', 0, CURRENT_TIMESTAMP, 14.6553, 121.03037, 'Close to Contis', '+987654123')
insert into users(user_nm, passwd, user_typ, user_pos_time, latitude, longitude, address, phone) values ('krafts', 'password3', 0, CURRENT_TIMESTAMP, 14.66205, 121.01941, 'Near Kamay Krafts', '+369852147')
